...
for(let  country of countries){
  ...
  let countryData={countryNname,population,currencyName,capital}
  myCountries.push(countryData)
}
var population=myCountries.filter(pop=>pop.population>200000000).map(data=>data.countryNname)
console.log(population);



// china currency
// var china=myCountries.find(cur=>cur.countryNname=="China").currencyName
// console.log(china);


// india details
// var india=myCountries.find(name=>name.countryNname=="India")
// console.log(india);


// console.log(myCountries);

// to print countries names
// myCountries.map(name=>name.countryNname).forEach(name=>console.log(name))
// myCountries.forEach(name=>console.log(name.countryNname))
